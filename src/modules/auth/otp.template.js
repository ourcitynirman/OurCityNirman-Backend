    ...
    <tr>
      <td align="center" style="padding: 40px 16px;">
        <table class="email-container dark-card" role="presentation" cellpadding="0" cellspacing="0" border="0"
          width="520" style="max-width: 520px; width: 100%; background-color: #ffffff; border-radius: 16px; overflow: hidden; border: 1px solid #fed7aa;">
          <tr>
          ...
          <tr>
            <td class="email-body-cell dark-card" align="center" style="padding: 36px 40px 32px; background-color: #ffffff;">
              ...
              <h1 style="margin: 0 0 8px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Arial, sans-serif; font-size: 22px; font-weight: 700; color: #9a3412; text-align: center;">Verify Your Email</h1>
              <p style="margin: 0 0 6px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Arial, sans-serif; font-size: 15px; color: #374151; text-align: center;">Hello <strong>${fullName}</strong>,</p>
              <p style="margin: 0 0 28px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Arial, sans-serif; font-size: 15px; color: #6b7280; text-align: center; line-height: 1.7;">
                Use the OTP below to complete your <strong style="color:#ea580c;">Our City Nirman</strong> account registration.
              </p>
              ...
              <p style="margin: 0 0 6px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Arial, sans-serif; font-size: 13px; color: #f97316; font-weight: 500; text-align: center;">&#9201; Valid for <strong>5 minutes only</strong></p>
              <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="margin-top: 24px;">
                <tr>
                  <td style="background-color: #fff7ed; border: 1px solid #fed7aa; border-left: 4px solid #f97316; border-radius: 8px; padding: 14px 16px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Arial, sans-serif; font-size: 13px; color: #9a3412; line-height: 1.6; text-align: left;">
                    &#9888;&#65039; <strong>Never share this OTP</strong> with anyone, including Our City Nirman staff. If you did not request this, please ignore this email.
                  </td>
                </tr>
              </table>
            </td>
